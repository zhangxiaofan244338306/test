                    ...
                    <div class="navbar navbar-default">
                            <form action="<?php echo U('order/export_order');?>" id="search-form2" class="navbar-form form-inline" method="post">
                                <div class="form-group">
                                    <label class="control-label labelTop1" for="input-order-id">收货人</label>
                                ...
                                <div class="form-group selectDown selectDownL selectDownL1 ">
                                ...
                                <div class="form-group selectDown">
                                ...
                                <div class="form-group selectDown selectDownL">
                                ...
                                <div class="form-group selectDown selectDownL1">
