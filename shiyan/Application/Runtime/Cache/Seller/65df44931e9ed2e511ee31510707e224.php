...
<body class="[body]">
    ...
    <div class="flool classlist">
        <div class="fl category1">
            <ul>
                        <li >
                           <a href="javascript:void(0);"  data-id="0">店铺设置</a>
                        </li>
                        <li >
                           <a href="javascript:void(0);"  data-id="1">店铺装修</a>
                        </li>
                        <li >
                           <a href="javascript:void(0);"  data-id="2">店铺导航</a>
                        </li>
                        <li >
                           <a href="javascript:void(0);"  data-id="3">经营类目</a>
                        </li>
                        <li >
                           <a href="javascript:void(0);"  data-id="4">店铺信息</a>
                        </li> 
                        <li >
                           <a href="javascript:void(0);"  data-id="4">店铺分类</a>
                        </li>                                               
