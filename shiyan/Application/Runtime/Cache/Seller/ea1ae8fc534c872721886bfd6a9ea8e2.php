                        ...
                        <!--
                         ...
                         -->   
				           <!-- <div class="form-group pull-right">
					            <a href="<?php echo U('Promotion/prom_order_info');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加订单活动</a>
				            </div> -->		          
			          <!-- </form> -->
	                <!-- </div> -->
                    <div id="ajax_return">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                                        ...
                                        <td class="text-center"><?php echo ($vo["log_id"]); ?></td>
                                        <td class="text-center"><?php echo ($vo["user_name"]); ?></td>
                                        <td class="text-center"><?php echo ($vo["log_info"]); ?></td>
                                        <td class="text-center"><?php echo ($vo["log_ip"]); ?></td>
                                        <td class="text-center"><?php echo (date("Y-m-d H:i:s",$vo["log_time"])); ?></td>
