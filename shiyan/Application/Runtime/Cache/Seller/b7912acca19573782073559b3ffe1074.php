        ...
        <div class="container-fluid" style="padding-right: 0px; padding-left: 0px; ">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"> 编辑商品促销活动  </h3>
                </div>
                <div class="panel-body ">   
                    <!--表单数据-->
                    <form method="post" id="promotion" action="<?php echo U('Promotion/prom_goods_save');?>">                    
                        <!--通用信息-->
                        ...
                        <div class="tab-pane active" id="tab_tongyong">                           
                            <table class="table table-bordered">
			                    ...
			                    <tr>
				                    ...
				                    <td class="col-sm-8">
							        <textarea class="span12 ckeditor" id="post_content" placeholder="请输入活动介绍" name="description" title="">
