...
<div class="wrapper">
 ...
 $x=123; var_dump($x); ?>
                                    ...
                                    <td class="text-warning">保存后，生成新的二维码</td>
										...
										<tr>
											...
											<td>
												<div style="width: 200px;height: 80px;">
													<img height="80" id="store_logo" src="<?php if(empty($store["store_logo"])): else: echo ($store["store_logo"]); endif; ?>"
													 nc_type="store_label">
												</div>
										...
										<tr>
											...
											<td>
												<div style="height:100px;">
													<img height="120" id="store_banner" src="<?php if(empty($store["store_banner"])): ?>/Public/images/not_adv.jpg<?php else: echo ($store["store_banner"]); endif; ?>"
													 nc_type="store_label">
												</div>
												...
												<p>banner背景颜色</p>
												<p><input class="form-control" name="bgcolor" type="color" value="<?php echo ($info["bgcolor"]); ?>" /></p>
											</td>
											<!-- <td >
                                		<span class="text-warning">建议使用宽1000像素*高250像素的图片；点击下方"提交"按钮后生效。</span>
                                		<p><input type="button" class="button" onClick="GetUploadify(1,'store_banner','seller','callback2')"  value="上传banner"/></p>
										...
										<tr>
											<td>满多少免运费：</td>
											<td><input type="text" class="form-control" name="store_free_price" value="<?php echo ($store["store_free_price"]); ?>"
