                        ...
                        <!--
                         ...
                         -->   
				            <div class="form-group pull-right">
					            <a href="<?php echo U('Promotion/add_rush');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加抢购活动</a>
				            </div>		          
			          <!-- </form> -->
	                </div>
                    <div id="ajax_return">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
									...
									<td class="text-center">抢购总量</td>
									<td class="text-center">抢购价格</td>
                                    <td class="text-center">活动商品</td>
                                    <td class="text-center">开始时间</td>
                                    <td class="text-center">结束时间</td>
                                    <td class="text-center">抢购状态</td>
                                    <td class="text-center">已购买</td>
                                ...
                                <?php if(is_array($prom_list)): foreach($prom_list as $k=>$vo): ?><tr>
                                        ...
                                        <td class="text-center"><?php echo ($vo["goods_num"]); ?></td>
                                        <td class="text-center"><?php echo ($vo["price"]); ?></td>
                                        <td class="text-center"><?php echo ($vo["goods_name"]); ?></td>
                                        <td class="text-center"><?php echo (date('Y-m-d H:i',$vo["start_time"])); ?></td>
                                        <td class="text-center"><?php echo (date('Y-m-d H:i',$vo["end_time"])); ?></td>
                                        <td class="text-center"><?php echo ($state[$vo[status]]); ?></td>
                                        <td class="text-center"><?php echo ($vo["buy_num"]); ?></td>
                                        <td class="text-center">
