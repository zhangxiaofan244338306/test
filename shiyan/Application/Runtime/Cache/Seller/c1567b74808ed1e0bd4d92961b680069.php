                        ...
                        <!--
                         ...
                         -->   
				            <div class="form-group pull-right">
					            <a href="<?php echo U('Promotion/add_group_buy');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加团购活动</a>
				            </div>		          
			          <!-- </form> -->
	                </div>
                    <div id="ajax_return">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($prom_list)): foreach($prom_list as $k=>$vo): ?><tr>
                                        ...
                                        <td class="text-center"><?php echo (getSubstr($vo["title"],0,30)); ?></td>
                                        <td class="text-center"><?php echo ($vo["price"]); ?></td>
                                        <td class="text-center"><?php echo ($vo["start_time"]); ?></td>
                                        <td class="text-center"><?php echo ($vo["end_time"]); ?></td>
                                        <td class="text-center"><?php echo ($vo["buy_num"]); ?></td>
										<td class="text-center"><?php echo ($vo["goods_num"]); ?></td>
                                        <td class="text-center"><?php echo ($vo["rebate"]); ?></td>
