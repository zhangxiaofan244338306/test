        ...
        <div class="row" style="padding:0px">
           <div class="col-xs-12">
            <div class="panel panel-default">
                ...
                <nav class="navbar navbar-default FormNew">	     
			        <div class="collapse navbar-collapse">
			          <form action="<?php echo U('Comment/ask_list');?>" id="search-form2" class="navbar-form form-inline FormNew" role="search" method="post">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($comment_list)): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-center">
                                            <img width="20" height="20" src="/Public/images/<?php if($list[is_show] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal2('goods_consult','id','<?php echo ($list["id"]); ?>','is_show',this)"/>
                                        </td>
                            ...
                            <select style="height: 33px;vertical-align: middle;margin-left: 20px;" name="operate" id="operate">
                                <option value="0">操作选择</option>
                                <option value="show">显示</option>
                                <option value="hide">隐藏</option>
                                <option value="del">删除</option>
                            </select>
                            <button class="btn btn-info" onclick="op()">确定</button>
