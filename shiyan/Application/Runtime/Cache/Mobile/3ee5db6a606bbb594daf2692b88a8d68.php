	...
	<div class="order ajax_return">
	   <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="order_list">
          <h2>
                  ...
                  <img src="/Application/Mobile/View/Static/images/dianpu.png" /><span>店铺名称:<?php echo ($storeList[$list['store_id']]['store_name']); ?></span>                  
              ...
              <a href="javascript:void(0);">    
                  <strong><img src="/Application/Mobile/View/Static/images/icojiantou1.png" /></strong>
              </a>
          </h2>
