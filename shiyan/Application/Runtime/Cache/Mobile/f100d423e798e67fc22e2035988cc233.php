...
<div class="com_top">
	...
	<dl>
		<dt>
		<img src="<?php echo ((isset($user['head_pic']) && ($user['head_pic'] !== ""))?($user['head_pic']):" /Application/Mobile/View/Static/images/user68.jpg"); ?>">
...
<div class="Wallet">
	...
	<a href="<?php echo U('User/points');?>"><em class="Icon Icon6"></em><dl class="b"><dt>充值和积分</dt><dd>&nbsp;</dd></dl></a>
	...
	<a href="/index.php/Home/Addapply/agreement.html"><em class="Icon Icon1"></em><dl><dt>商家入住</dt><dd>&nbsp;</dd></dl></a>  
