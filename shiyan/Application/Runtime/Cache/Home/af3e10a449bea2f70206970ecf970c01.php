...
<head>
<meta charset="UTF-8">
<title><?php echo ($goods["goods_name"]); ?>-<?php echo ($plmshop_config['shop_info_store_title']); ?></title>
...
<!--<link rel="stylesheet" href="/Application/Home/View/Static/css/common.css?v=1459218814">-->
</head>
...
<script type="text/javascript" src="/Application/Home/View/Static/js/jquery.jqzoom.js"></script>
<script src="/Public/js/pc_common.js"></script>
<link rel="stylesheet" type="text/css" href="/Application/Home/View/Static/css/detail.css">
<link rel="stylesheet" type="text/css" href="/Application/Home/View/Static/css/jquery.jqzoom.css">
<link rel="stylesheet" href="/Application/Home/View/Static/css/location.css" type="text/css"><!-- 收货地址，物流运费 -->
        ...
        <div class="product-value">
          <div class="product-value-area">
            <ul class="product-value-anything product-value-price hide" style="display: block;">
              ...
              <?php if(($goods['shop_price'] >= ($goods['exchange_integral']/$point_rate)) AND $goods['exchange_integral'] > 0): ?><li class="nett fn-clear" style="position: relative;top:10px">
          ...
          <div class="product-norm" id="productNorm" style="position: relative;top:20px">
			...
			<dl class="sevice public-pl67 marginFR25">
              ...
              <span style="color:#aaa;">
              	...
              	<a href="tencent://message/?uin=<?php echo ($store["store_qq"]); ?>&Site=派乐咪商城&Menu=yes"> <img src="/Public/images/qq.gif" />  </a>
              </span>
              </dd>
            </dl>
...
<div class="product-side fl">
  ...
  <div class="side-public side-look sale-top">
    ...
    <ul>
      <?php
 $md5_key = md5("select * from `__PREFIX__goods` where is_recommend = 1 and cat_id3=$goods[cat_id3] order by goods_id desc limit 6"); $result_name = $sql_result_v = S("sql_".$md5_key); if(empty($sql_result_v)) { $Model = new \Think\Model(); $result_name = $sql_result_v = $Model->query("select * from `__PREFIX__goods` where is_recommend = 1 and cat_id3=$goods[cat_id3] order by goods_id desc limit 6"); S("sql_".$md5_key,$sql_result_v,0); } foreach($sql_result_v as $k=>$v): ?><li>
      ...
      <div class="fn-mc fix">
        ...
        <div class="fn-mc-rt">
          ...
          <p class="double_points">
            <span>发表评价可获得派乐咪积分哦~ <br> 加精置顶还可赢双倍积分<br></span>
           	 详见<a href="">[积分规则]</a></p>
        </div>
      </div>
      <!-- /.fn-mc -->
...
<!--转单非生鲜-->
	<p style="font-weight: bold;padding: 20px 0 0 30px;">本商品由派乐咪网入驻商家提供配送服务，购买前请仔细阅读以下退货说明</p>
	<dl>
	<dt class="red">商家直送的商品退货流程（七天无理由退货）：</dt>
		<dd>
		  <ol>
		    ...
		    <li>商品退回检測无误后，派乐咪网将提交退款申请, 通过线上支付的订单办理退货, 实际款项会依照各银行作业时间返还至您原支付方式。</li>
		    <li>若退回商品有缺件、影响二次销售状况时，不符合退货条件, 退款作业将暂时停止，派乐咪网客服人员会与您联系说明，并由商家将商品返还给您 （如对于结果有异议,可联系<a class="sevice_url" target="_blank" href="">派乐咪客服咨询</a>或<a class="sevice_url" target="_blank" href="">重新发起申请退货</a>并补充相关凭证）。</li>
		  </ol>
		</dd>
		...
		<dd>
		  <ol>
		    ...
		    <li>商品退回检測无误后，派乐咪网将提交退款申请, 通过线上支付的订单办理退货, 实际款项会依照各银行作业时间返还至您原支付方式。同时派乐咪网会补贴10元抵用券到您的派乐咪网帐户以作为退货运费补偿。</li>
		    <li>若退回商品有缺件、影响二次销售状况时，不符合退货条件, 退款作业将暂时停止，派乐咪网客服人员会与您联系说明，并由商家将商品返还给您 （如对于结果有异议,可连系<a class="sevice_url" target="_blank" href="">派乐咪客服咨询</a>或<a class="sevice_url" target="_blank" href="">重新发起申请退货</a>并补充相关凭证）。</li>
		  </ol>
		</dd>
		<dt class="red">注意：</dt>
		<dd>
		  <ol>
		    <li>顾客办理退货后，需要自行联系物流公司将退货商品寄回派乐咪网指定退货地点；该商品为派乐咪入驻商家直送，暂未提供上门取件的服务，不便之处，敬请谅解。</li>
		    <li>派乐咪网办理退货不收取任何手续费、入仓费等费用，退货时如遇快递公司要求收取额外费用，建议您更换其他快递。</li>
		    <li>顾客需选择快递方式将商品寄回，并支付快递费用，本商品退货不接受平邮或以到付形式寄回包裹。</li>
		    <li>由“有理由退货”而产生的派乐咪运费补贴（10元抵用券）有效期为2个月。</li>
		    <li>多张订单同一包裹寄回，仅补贴一次运费。派乐咪网有权对无正当理由多次退货或拒收商品的用户保留不再给予10元抵用券退货补贴的权利。</li>
		    <li>退回来的包裹中用纸条写明退货的订单号和派乐咪帐号名称，才可以顺利完成退货。</li>
		...
		<dd>
		  <ol>
		    <li>此商品由入驻派乐咪网的商家直接发货，且不支持货到付款。</li>
		    <li>商品会以第三方物流方式配送。</li>
		    <li>配送地址需在快递可送货范围内，如遇偏远地区无法送达的地方，我们会将商品送达当地最近物流点并通知顾客自提。</li>
		    <li>物品需本人签收，收到物品请务必先行检查，确认完好后再签收。</li>
		    <li>如果收货过程中，发现任何问题请第一时间联系派乐咪网客服021-xxxxxx，我们会及时解决您的问题。</li>
		  </ol>
		</dd>
		<dt class="red">以下状况派乐咪网将不接受您的退货：</dt>
		<dd>
		  <ol>
		    <li>商品非派乐咪网所贩售出之商品，如：商品序号不符。</li>
...
<div style="display:none">
      <ul id="look_see">
       <?php if(is_array($look_see)): foreach($look_see as $key=>$look): ?><li>
	     	 <a href="<?php echo U('Goods/goodsInfo',array('id'=>$look[goods_id]));?>" class="look-img" target="_blank"> <img src="<?php echo (goods_thum_images($look["goods_id"],200,200)); ?>" alt=""></a>
	         <h4 class="look-title">
	         	<a href="<?php echo U('Goods/goodsInfo',array('id'=>$look[goods_id]));?>"><?php echo (getSubstr($look["goods_name"],0,30)); ?></a>
	         </h4>
	         <p class="look-price">
...
<!--------收货地址，物流运费-开始-------------->
<script src="/Application/Home/View/Static/js/location.js"></script>
<!--------收货地址，物流运费--结束-------------->
