  ...
  <div class="container">
    <div class="logo fl">
    	<a href="/" target="_blank" class="item fl"><img height="60" width="160" src="<?php echo ($plmshop_config['shop_info_store_logo']); ?>"></a>
    	 <!-- <a href="" target="_blank" class="item fl"><img height="60" width="140" src="/Application/Home/View/Static/images/logo.jpg"></a> -->
    </div>
    <div fnp="m-top-search-form" class="m-top-search-form fl">
     <form name="sourch_form" id="sourch_form" method="post" action="<?php echo U("/Home/Goods/search");?>">
        ...
        <div class="s-hotword">
        	<?php if(is_array($plmshop_config["hot_keywords"])): foreach($plmshop_config["hot_keywords"] as $k=>$wd): ?><a href="<?php echo U('Home/Goods/search',array('q'=>$wd));?>" <?php if($wd == I('q')): ?>class="ht"<?php endif; ?>><?php echo ($wd); ?></a><?php endforeach; endif; ?>
        </div>
...
<div id="pageContent">
  ...
  .s-pg a.s-next {margin-left: 357px;}
            ...
            <div class="sub-columns">
              ...
              <div class="right-wrap">
                ...
                <?php if(is_array($brand_list)): $i = 0; $__LIST__ = $brand_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i; if(($v2[parent_cat_id] == $vo[id]) AND ($v2[is_hot] == 1)): ?><li class="item <?php if(($mod) == "1"): ?>even<?php endif; ?>">
                      ...
                      <img class="nav-prod" src="/Application/Home/View/Static/images/loading.gif" alt="" data-images="<?php echo ($v2["logo"]); ?>"></a>
    ...
    <div class="module eidtModule" moduleId="1081037_main" parentModuleId ="1081037" moduleCode="cms-index-cchannel">
      <div class="layout container mt30">
        ...
        <div class="feture-cates">
          <ul class="cates-left">
          <?php $pid =50;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><li class="item">
          ...
          <?php $pid =51;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><li class="item">
               <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                 <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>">
               </a>
            </li><?php endforeach; ?>              
          <?php $pid =52;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><li class="item">
               <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                 <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>">
               </a>
            </li><?php endforeach; ?>    
          <?php $pid =53;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><li class="item">
               <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                 <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>">
               </a>
            </li><?php endforeach; ?>    
          <?php $pid =54;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><li class="item">
               <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                 <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>">
               </a>
            </li><?php endforeach; ?>    
          <?php $pid =55;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><li class="item">
               <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                 <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>">
               </a>
            </li><?php endforeach; ?>                                        
          ...
          <div class="cates-center" fnp="slide">
            <ul class="ui-switchable-content" data-role="content">
              <li class="panel panel-action">
                <?php $pid =56;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>  
                <?php $pid =57;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>  
              ...
              <li class="panel">
                <?php $pid =58;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>  
                <?php $pid =59;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>                
      ...
      <ul class="slide-nav ui-switchable-nav" data-role="nav">
        ...
        <li class="ui-switchable-trigger"><span>2</span></li> 
          ...
          <ul class="cates-right">
                <?php $pid =60;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>
                <?php $pid =61;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>                  
          ...
          <div class="floor-right" fnp="tab-switch">
            ...
            <div class="layout-bd eidtModule" style="overflow:hidden" data-role="panels">
              <div class="pics pics-01 dn eidtModule" moduleId="1081777_selectedAd">
                <a class="item item-big" href="javascript:;"><img data-original="/Application/Home/View/Static/images/jingxuan/1-1.png" src="" class="img100 prod"></a>
                <a class="item" href="javascript:;"><img data-original="/Application/Home/View/Static/images/jingxuan/2-1.jpg" src="" class="img100 img-effect prod"></a>
                <a class="item" href="javascript:;"><img data-original="/Application/Home/View/Static/images/jingxuan/2-2.jpg" src="" class="img100 img-effect prod"></a>
                <a class="item nbdr" href="javascript:;"><img data-original="/Application/Home/View/Static/images/jingxuan/2-3.jpg" src="" class="img100 img-effect prod"></a>
                <a class="item" href="javascript:;"><img data-original="/Application/Home/View/Static/images/jingxuan/2-4.jpg" src="" class="img100 img-effect prod"></a>
                <a class="item" href="javascript:;"><img data-original="/Application/Home/View/Static/images/jingxuan/2-5.jpg" src="" class="img100 img-effect prod"></a>
                <a class="item nbdr" href="javascript:;"><img data-original="/Application/Home/View/Static/images/jingxuan/2-6.jpg" src="" class="img100 img-effect prod"></a>
            </div>
    ...
    <?php $pid =100+$k;$ad_position = M("ad_position")->cache(true,PLM_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1551762000 and end_time > 1551762000 ")->order("orderby desc")->cache(true,PLM_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="module eidtModule" parentModuleId="" moduleId="" style="min-height: 25px;">
        <div class="container mt30"><a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?> class="banner-img-single">
          <img width="1188" height="80" class="prod" src="<?php echo ($v[ad_code]); ?>" title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" alt=""/></a>
        </div>
      ...
      <div class="layout boutique container mt30">
        ...
        <div class="layout-bd">
          <div class="boutique-left">
            <?php
 $md5_key = md5("select * from __PREFIX__goods where is_new=1 order by sort limit 7"); $result_name = $sql_result_v = S("sql_".$md5_key); if(empty($sql_result_v)) { $Model = new \Think\Model(); $result_name = $sql_result_v = $Model->query("select * from __PREFIX__goods where is_new=1 order by sort limit 7"); S("sql_".$md5_key,$sql_result_v,0); } foreach($sql_result_v as $k=>$v): ?><div class="item <?php if($k == 0): ?>item-big<?php else: ?>item-small<?php endif; ?> ">
            ...
            <div class="comment-list" fnp="comments">
              <ul data-role="content">
                <li class="comment">
                  ...
                  <div class="info">
                    <p class="author"><img data-original="" class="prod selection-prod" src="/Application/Home/View/Static/images/80_80.gif">
                      <span>匿名用户</span>
                    </p>
