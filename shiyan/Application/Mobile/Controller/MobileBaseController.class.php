...
class MobileBaseController extends Controller {
    ...
    public function public_assign()
    {
       ...
       $tp_config = M('config')->cache(true,PLM_CACHE_TIME)->select();       
       ...
       $brand_list = M('brand')->cache(true,PLM_CACHE_TIME)->field('id,cat_id1,logo,is_hot')->where("cat_id1>0")->select(); 
 //       //接口测试
